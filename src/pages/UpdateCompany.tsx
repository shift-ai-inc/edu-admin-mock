...
const fetchCompanyData = async (
  companyId: string
): Promise<Partial<UpdateCompanyFormValues>> => {
...
export default function UpdateCompany() {
  ...
  const [initialIsActive, setInitialIsActive] = useState<boolean | undefined>(
    undefined
  );
  ...
  const form = useForm<UpdateCompanyFormValues>({
    ...
    defaultValues: {
      // Initialize with empty/default values (updated)
      companyId: companyId,
      companyName: "",
      address: "",
      contactInfo: "",
  ...
  const deactivateRequiresConfirm =
    initialIsActive === true && watchedIsActive === false;
  ...
  return (
    <div className="p-8">
      <h2 className="text-2xl font-semibold text-gray-900 mb-6">
        企業情報更新 ({form.getValues("companyName") || companyId})
      </h2>
      <Form {...form}>
        <form
        ...
        >
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="例: 東京都千代田区..." {...field} />
                </FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="例: 03-xxxx-xxxx" {...field} />
                </FormControl>
          ...
          <h3 className="text-lg font-medium border-b pb-2 mb-4 pt-4">
            請求情報
          </h3>
          <FormField
            control={form.control}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="例: 管理者 太郎" {...field} />
                </FormControl>
                <FormDescription>
                  （このシステムを利用する企業の代表管理者）
                </FormDescription>
