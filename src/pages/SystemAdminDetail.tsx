import { useParams, useNavigate } from "react-router-dom"; // Removed React import
import { mockSystemAdmins } from "@/data/mockSystemAdmins"; // Import mock data
import { getPermissionLevelName, getStatusName } from "@/types/system-admin"; // Import type and helpers
import {
  Card,
  CardContent,
  CardHeader,
