import { Survey, SkillLevel } from "@/types/survey";
...
export const mockSurveys: Survey[] = [
  ...
  },
  {
    id: "survey-002",
    title: "新製品アイデア募集サーベイ",
    type: "scenario-based", // Changed to a valid SurveyType
  ...
  },
  {
    ...
    description:
      "先日実施されたリーダーシップ研修の効果を測定するためのサーベイです。",
...
export const updateMockSurvey = (
  id: string,
  data: Partial<Omit<Survey, "id" | "createdAt" | "questionsCount">> & {
