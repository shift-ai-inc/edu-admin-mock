    ...
    "V1": [
      {
        ...
        correctAnswer: "opt2", points: 10, category: "チームマネジメント", difficulty: "medium",
      ...
      },
      {
        ...
        correctAnswer: ["optA", "optB", "optC"], points: 15, category: "リーダーシップ", difficulty: "hard",
        createdAt: "2023-01-10T10:05:00Z", updatedAt: "2023-01-10T10:05:00Z"
      },
      {
        ...
        points: 20, category: "自己分析", difficulty: "medium",
        createdAt: "2023-01-10T10:10:00Z", updatedAt: "2023-01-10T10:10:00Z"
      },
    ],
    "V2": [ 
       {
        ...
        correctAnswer: "opt2v2", points: 10, category: "チームマネジメント", difficulty: "medium",
        createdAt: "2023-05-15T11:00:00Z", updatedAt: "2023-05-15T11:00:00Z"
      },
       {
        id: "Q-001-V2-2", assessmentId: "ASS-001", versionId: "V2", order: 2,
        text: "あなたのリーダーシップスタイルを簡潔に説明してください。(V2)", type: "text",
        correctAnswer: undefined, points: 15, category: "自己分析", difficulty: "medium",
        createdAt: "2023-05-15T11:05:00Z", updatedAt: "2023-05-15T11:05:00Z"
      },
      {
        ...
        correctAnswer: "optZ", points: 10, category: "プロジェクト管理", difficulty: "easy",
        createdAt: "2023-05-15T11:10:00Z", updatedAt: "2023-05-15T11:10:00Z"
      },
    ],
     "V3": [ 
       {
        ...
        correctAnswer: "opt2v3", points: 10, category: "チームマネジメント", difficulty: "medium",
      ...
      },
       {
        ...
        correctAnswer: undefined, points: 15, category: "自己分析", difficulty: "medium",
        createdAt: "2024-01-20T09:05:00Z", updatedAt: "2024-01-20T09:05:00Z"
      },
      {
        ...
        correctAnswer: "optZv3", points: 10, category: "プロジェクト管理", difficulty: "easy",
        createdAt: "2024-01-20T09:10:00Z", updatedAt: "2024-01-20T09:10:00Z"
      },
       {
        ...
        correctAnswer: ["optF1", "optF2", "optF3", "optF4"], points: 15, category: "コミュニケーション", difficulty: "medium",
        createdAt: "2024-01-20T09:15:00Z", updatedAt: "2024-01-20T09:15:00Z"
      },
    ],
  },
  "ASS-002": { // エンジニアスキル評価
    "V1": [
       {
        ...
        correctAnswer: "optS3", points: 10, category: "ソフトウェア設計", difficulty: "medium",
        createdAt: "2023-03-01T14:00:00Z", updatedAt: "2023-03-01T14:00:00Z"
      },
    ],
    "V2": [
       {
        ...
        correctAnswer: "optS3v2", points: 10, category: "ソフトウェア設計", difficulty: "medium",
        createdAt: "2023-08-01T15:00:00Z", updatedAt: "2023-08-01T15:00:00Z"
      },
       {
        id: "Q-002-V2-2", assessmentId: "ASS-002", versionId: "V2", order: 2,
        text: "REST APIの設計において冪等性が重要な理由を説明してください。", type: "text",
        correctAnswer: undefined, points: 15, category: "API設計", difficulty: "hard",
        createdAt: "2023-08-01T15:05:00Z", updatedAt: "2023-08-01T15:05:00Z"
      },
    ],
  },
...
export const getQuestionsForVersion = (assessmentId: string, versionId: string): AssessmentQuestion[] => {
  return mockAssessmentQuestions[assessmentId]?.[versionId]?.sort((a, b) => a.order - b.order) ?? [];
};
